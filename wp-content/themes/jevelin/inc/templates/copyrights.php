...
$copyrights = '';
$dev = 'http://instagram.com/84michaelnas';
if( jevelin_option( 'copyright_deveveloper_all', true ) == true ) :
	$copyrights = '<span class="developer-copyrights '.(( jevelin_option('copyright_deveveloper', true) == false ) ? ' sh-hidden' : '' ).'">
		'.esc_html__( 'Template desenvolvido por', 'jevelin' ).' <a href="'.esc_attr( $dev ).'" target="blank"><strong>'.esc_html__( 'Michael', 'jevelin' ).'</strong>.</a>
		</span>';
endif;
