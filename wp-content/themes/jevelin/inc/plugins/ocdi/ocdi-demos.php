    ...
    */
    foreach( array_reverse( $wpbakery ) as $demo ) :
        ...
        $thisdemo = array(
            ...
            'import_file_url'            => 'https://api.shufflehound.com/jevelin/ocdi_wpbakery_files/'.$slug.'/'.$slug.'_content.xml?v=7',
            'import_json'                => array(
                array(
        ...
        if( $widgets ) :
            $thisdemo['import_widget_file_url'] = 'https://api.shufflehound.com/jevelin/ocdi_wpbakery_files/'.$slug.'/'.$slug.'_widgets.wie';
        else :
