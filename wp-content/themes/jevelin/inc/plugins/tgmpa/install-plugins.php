    ...
    function jevelin_register_required_plugins() {
        ...
        tgmpa( array(
            ...
            array(
                ...
                'image'     => 'wpbakery.png',
                'slug'      => 'js_composer',
                'source'    => 'https://cdn.shufflehound.com/theme-plugins/visual-composer-OL6A44-6.0.5.zip?ver=6.6.0',
                'required'  => true,
                'version'   => '6.6.0',
            ),
            ...
            array(
                ...
                'slug'      => 'revslider',
                'source'    => 'https://cdn.shufflehound.com/theme-plugins/slider-revolution-QB4L22.zip?ver=6.4.6',
                'required'  => true,
                'version'   => '6.4.6',
            ),
